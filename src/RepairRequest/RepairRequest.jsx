    ...
    return (
        <div>
            ...
            <div className="min-h-screen bg-gray-100 flex items-center justify-center">
                ...
                >
                    <div className="mb-4">
                        <label className="block text-gray-700" style={{ fontFamily: 'MyCustomFont', fontSize: 20 }} >อาคาร
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700" style={{ fontFamily: 'MyCustomFont', fontSize: 20 }}>ห้อง
                            <span className='text-red-500'> *</span>
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700" style={{ fontFamily: 'MyCustomFont', fontSize: 20 }}>ชั้น
                            <span className='text-red-500'> *</span>
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700" style={{ fontFamily: 'MyCustomFont', fontSize: 20 }}>วันที่แจ้งซ่อม
                            <span className='text-red-500'> *</span>
                        </label>
                        <input
                            type="date"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700" style={{ fontFamily: 'MyCustomFont', fontSize: 20 }}>รายละเอียด
                            <span className='text-red-500'> *</span>
                        </label>
                        <textarea
                            name="details"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700" style={{ fontFamily: 'MyCustomFont', fontSize: 20 }}>อุปกรณ์
                    ...
                    <div>
                        <label className="block text-gray-700" style={{ fontFamily: 'MyCustomFont', fontSize: 20 }}>อัพโหลดรูปภาพ
                            <span className='text-red-500'> *</span></label>
                    </div>
                    ...
                    <div class="flex items-center justify-center w-full mb-4">
                        ...
                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 20 20"><path fill="#6e6868" d="M10 5.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-4-2a.5.5 0 0 0-1 0V5H3.5a.5.5 0 0 0 0 1H5v1.5a.5.5 0 0 0 1 0V6h1.5a.5.5 0 0 0 0-1H6zm8 .5h-3.207a5.5 5.5 0 0 0-.393-1H14a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3v-3.6q.476.244 1 .393V14c0 .373.102.722.28 1.02l4.669-4.588a1.5 1.5 0 0 1 2.102 0l4.67 4.588A2 2 0 0 0 16 14V6a2 2 0 0 0-2-2m0 3.5a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0m-1 0a.5.5 0 1 0-1 0a.5.5 0 0 0 1 0m-8.012 8.226A2 2 0 0 0 6 16h8c.37 0 .715-.1 1.012-.274l-4.662-4.58a.5.5 0 0 0-.7 0z">
                                </path >
                                </svg>
                                <p class="mb-2 text-sm text-gray-500" >
                                    <span style={{ fontFamily: 'MyCustomFont2', fontSize: 14 }}>Click to upload</span></p>
                                <p class="text-gray-500" style={{ fontFamily: 'MyCustomFont2', fontSize: 14 }}>PNG, JPG
                                    <span style={{ fontFamily: 'MyCustomFont2', fontSize: 14 }}></span>  (MAX. 800x400px)</p>
                            </div>
